    ...
    return (
        <nav className={floating && "floating"}>
            <div className="nav-content" >
                ...
                <ul id="header-social">
				    <li><a href="https://www.facebook.com/FuelFighterNTNU" title="facebook" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFacebookF} /></a></li>
				    <li><a href="https://www.instagram.com/fuelfighter_ntnu/" title="instagram" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faInstagram} /></a></li>
