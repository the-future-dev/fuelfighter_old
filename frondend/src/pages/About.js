        ...
        <>
            ...
            <div className={globalClasses.window} >
                <div className={`${globalClasses.section} ${globalClasses.section_column}`}>
                    ...
                    <p className={`${globalClasses.description} ${globalClasses.two_thirds}`} >The Shell Eco Marathon is the world’s leading student engineering competition on energy efficiency. More than 200 teams from all around the world compete to make the most energy efficient car possible. The cars are divided into two classes: prototype and urban concept. Each of these classes contain three subclasses based on their source of power: Hydrogen, Battery Electric and Internal Combustion. The prototype cars are designed mainly with the aerodynamics in mind. {name} has only made one prototype car, that only competed in 2014 getting a 7th place finish. We feel it is more relevant for the future to design an urban concept car, that should simulate a future city car. This means that the car needs windshield wipers, indicators, horn etc. For every lap around the track the urban concept cars must stop, to simulate city driving. In the Urban Concept Battery Electric class the ranking is based on number of kilometers driven on 1 kWh (km/kWh). The Norwegian record, set by us in 2019, is 181 km/kWh.</p>
            ...
            <div className={globalClasses.window} style={{backgroundColor: '#f8f8f8'}} >
                ...
                <div className={`${globalClasses.section} ${globalClasses.section_column}`} >
                    ...
                    <p className={`${classes.FAQ_a} ${globalClasses.two_thirds}`}>The short answer is yes! {name} is a subject you can attend and you will get 7.5 credits. To make sure your specific study accepts this subject you should talk to your supervisor.</p>
                    */}
